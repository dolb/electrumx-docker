...
RUN echo 'DEFAULT_RPCUSER="zcluser"' > /home/zcluser/default_config \
&& X=`date | sha256sum | awk '{print $1}'` && echo DEFAULT_RPCPASS=\"$X\" >> /home/zcluser/default_config \
&& echo 'VK_SHA256="4bd498dae0aacfd8e98dc306338d017d9c08dd0918ead18172bd0aec2fc5df82"' >> /home/zcluser/default_config \
&& echo 'PK_SHA256="8bc20a7f013b2b58970cddd2e7ea028975c88ae7ceb9259a5344a16bc2c0eef7"' >> /home/zcluser/default_config
